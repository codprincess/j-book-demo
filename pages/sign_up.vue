          ...
          <a-col :span="12">
            <div class="login-right">
              <div class="login-form">
                ...
                <a-row type="flex" justify="center" >
                  <p style="width: 80%;color: #b5b5b5; font-size: 13px;text-align: center;margin-top: 10px">点击"注册"即表示您同意并愿意遵守简书的 <a>用户协议</a>和<a>隐私政策</a></p>
                </a-row >
                <div class="more-sign">
                  <h6>社交帐号注册</h6>
                  <a-row type="flex" justify="center" style="margin-top: 30px">

                    <div style="margin-right: 30px"><i-ant-design-wechat-outlined style="color:#00BB29;font-size: 30px" /></div>
